...
const Contact = () => {
  ...
  return (
    <main
      className="pb-5 lg:py-52 py-16 px-3 bg-[#f0ebe3] dark:bg-[#1f2937]"
      id="contact"
    >
        ...
        <div className="lg:flex xl:w-4/5 w-full xl:justify-normal justify-between mx-auto lg:pt-24">
          <section className="lg:pt-[60px] pt-8 xl:w-2/5">
            <div className="lg:block flex flex-wrap gap-x-4">
              ...
              <Contact_info
                title="Email"
                sub_title="jinushree94@gmail.com"
                icon={<MdMap />}
              />
              <Contact_info
                title="Phone"
                sub_title="+971- 58 807 39 30"
                icon={<MdMap />}
              />
            </div>
          </section>
            ...
            <form className="w-full">
              <div className="sm:flex gap-x-8 w-full mb-8">
                <label className="flex flex-col w-full gap-4 mb-8">
                  <p className="pl-12 text-[#262626] dark:text-white font-bold text-sm">
                    YOUR FULL NAME *
                  </p>
                  <input
                    type="text"
                    className="rounded-full h-[60px] px-8 border border-black border-solid outline-none"
                  />
                </label>
