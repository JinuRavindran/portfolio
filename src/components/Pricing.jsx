    ...
    return (
      <div className="relative hoverBtn">
        <div
          ...
          } bg-white rounded-[20px] py-[30px] px-[35px] relative overflow-hidden dark:text-black`}
        >
          ...
          <div className="absolute z-20 -right-6 -bottom-6 bg-[url('/pat-2.png')] bg-contain bg-center w-[131px] h-[131px]"></div>
        </div>
        {title === "FREELANCING" && (
          <button className="text-white bg-[#29a587] text-[13px] font-bold border-solid rounded-full px-[15px] h-[26px] absolute -top-3 right-8 z-20 shadowbtn">
            POPULAR
          </button>
        )}
      </div>
